...
df_login_tree_raw = query_adx_huge(db, query_login_tree)
...
# tree_data = '''
# {'parent': 'null',
#  'name': 'Current Onboard (12562) ',
#  'edge_name': 'Current Onboard (12562) ',
#  'children': [{'parent': 'Current Onboard (12562) ',
#    'name': 'No usage (5710) ',
#    'edge_name': 'No usage (5710) '},
#   {'parent': 'Current Onboard (12562) ',
#    'name': 'Only API (77) ',
#    'edge_name': 'Only API (77) ',
#    'children': [{'parent': 'Only API (77) ',
#      'name': 'api_week_cnt: 1 (26) ',
#      'edge_name': 'api_week_cnt: 1 (26) '},
#     {'parent': 'Only API (77) ',
#      'name': 'api_week_cnt: 2 (10) ',
#      'edge_name': 'api_week_cnt: 2 (10) '},
#     {'parent': 'Only API (77) ',
#      'name': 'api_week_cnt: 3 (8) ',
#      'edge_name': 'api_week_cnt: 3 (8) '},
#     {'parent': 'Only API (77) ',
#      'name': 'api_week_cnt: 4 (1) ',
#      'edge_name': 'api_week_cnt: 4 (1) '},
#     {'parent': 'Only API (77) ',
#      'name': 'api_week_cnt: 5 (32) ',
#      'edge_name': 'api_week_cnt: 5 (32) '}]},
#   {'parent': 'Current Onboard (12562) ',
#    'name': 'Only UI (5695) ',
#    'edge_name': 'Only UI (5695) ',
#    'children': [{'parent': 'Only UI (5695) ',
#      'name': 'ui_week_cnt: 1 (2146) ',
#      'edge_name': 'ui_week_cnt: 1 (2146) '},
#     {'parent': 'Only UI (5695) ',
#      'name': 'ui_week_cnt: 2 (1100) ',
#      'edge_name': 'ui_week_cnt: 2 (1100) '},
#     {'parent': 'Only UI (5695) ',
#      'name': 'ui_week_cnt: 3 (670) ',
#      'edge_name': 'ui_week_cnt: 3 (670) '},
#     {'parent': 'Only UI (5695) ',
#      'name': 'ui_week_cnt: 4 (631) ',
#      'edge_name': 'ui_week_cnt: 4 (631) '},
#     {'parent': 'Only UI (5695) ',
#      'name': 'ui_week_cnt: 5 (1148) ',
#      'edge_name': 'ui_week_cnt: 5 (1148) '}]},
#   {'parent': 'Current Onboard (12562) ',
#    'name': 'UI and API (1080) ',
#    'edge_name': 'UI and API (1080) ',
#    'children': [{'parent': 'UI and API (1080) ',
#      'name': 'week_cnt: 1 (58) ',
#      'edge_name': 'week_cnt: 1 (58) '},
#     {'parent': 'UI and API (1080) ',
#      'name': 'week_cnt: 2 (45) ',
#      'edge_name': 'week_cnt: 2 (45) '},
#     {'parent': 'UI and API (1080) ',
#      'name': 'week_cnt: 3 (61) ',
#      'edge_name': 'week_cnt: 3 (61) '},
#     {'parent': 'UI and API (1080) ',
#      'name': 'week_cnt: 4 (95) ',
#      'edge_name': 'week_cnt: 4 (95) '},
#     {'parent': 'UI and API (1080) ',
#      'name': 'week_cnt: 5 (821) ',
#      'edge_name': 'week_cnt: 5 (821) '}]}]}
# '''
...
# </html>
# """
# components.html(h,height=1000,
#        #scrolling=scrolling,
#        )



# df_ces_detail = query_adx_huge(db, 'ces_exp')

# df_target = df_ces_detail[df_ces_detail.Score_PR==99].head(1)

# df_multi = df_ces_detail[df_ces_detail.Total_Score > 0]
# col = ['Data_Date', 'CLP_ID', 'Total_Score', 
#        'Login_Score', 'XDR_Threat_Invest_Score', 'RI_Score', 
#        'Workflow_and_Automation_Score', 'TI_Score', 'ZTSA_Score', 'Sensor_Deployment_Score']
...
#   st.write(df_target.Login_details.tolist()[0])

# with col2:
#   st.markdown('#### Deployment details')
#   st.write(df_target.Sensor_Deployment_details.tolist()[0])
